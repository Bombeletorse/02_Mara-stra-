...
<head>
    ...
    <section class="home">
            <div class="banner-bg" id="top">
                    ...
                    <h1 class="al" align="center"> Marchés du marcredi </h1>
            ...
            <div class="map">
                <iframe src="https://www.google.com/maps/d/embed?mid=1_UMulq3jZygiXyjDykYpL4ux0Vr5tDel&ehbc=2E312F" width="1000" height="500"></iframe> 
                    <br><br><br><br>
                         <p><strong>Idée de recette </strong></p>
                        <p> Risotto aux légumes </p>
                        <img src="img/07.png" width="50%" height="50%">
                        <img src="img/08.png" width="100%" height="100%"><br><br> 
            </div>
