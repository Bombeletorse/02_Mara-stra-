...
<head>
    ...
    <section class="home">
            <div class="banner-bg" id="top">
                    ...
                    <h1 class="al" align="center"> Marchés du vendredi </h1>
            ...
            <div class="map">
                 <iframe src="https://www.google.com/maps/d/embed?mid=1NThUFKanz18pb5x7_-72sVWdK8fYzJkI&ehbc=2E312F" width="1000" height="500"></iframe> 
                   <br><br><br><br>
                         <p><strong>Idée de recette </strong></p>

                        <p> Soupe de légumes</p>
                        <img src="img/05.png" width="50%" height="50%">
                        <img src="img/06.png" width="100%" height="100%"><br><br> 
            </div>
