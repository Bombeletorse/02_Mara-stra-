...
<head>
    ...
    <section class="home">
            <div class="banner-bg" id="top">
                    ...
                    <h1 class="al" align="center"> Marchés du lundi </h1>
            ...
            <div class="map">
                  <iframe src="https://www.google.com/maps/d/embed?mid=1Wok8hO4M3fnAj4YSHi0eqDRv9qw4gLit&ehbc=2E312F"  height="500" width="1000"></iframe> 
                     <br>
                                 <br><br><br><br><br>
                                <p> <strong>Idée de recette :</strong></p>
                                  <p> <strong>Pain aux légumes:</strong><br>
                                 <img src="img/10.PNG" width="50%" height="50%">
                                 <img src="img/9.png" width="700" height="480">
            </div>
