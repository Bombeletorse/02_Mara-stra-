...
<head>
    ...
    <section class="home">
            <div class="banner-bg" id="top">
                    ...
                    <h1 class="al" align="center"> Marchés du samedi</h1>
            ...
            <div class="map">
            <iframe src="https://www.google.com/maps/d/embed?mid=1PHNbT3lttb5YZggXOI0_0wu8SZ5P83HP&ehbc=2E312F" width="1000" height="500"></iframe> 
                    <br><br><br><br>
                         <p><strong>Idée de recette </strong></p>

                        <p> Samossas de légumes  </p>
                        <img src="img/09.png" width="50%" height="50%">
                        <img src="img/010.png" width="100%" height="100%"><br><br> 
                     ...
                     <div class="box2">
                                ...
                                <form action="index.php" method="post">
                                   ...
                                   <p class="text_color">Nom et Prénom:</p>
                                    <input class="input" id="name"  type="text" name="email" ><br><br>
